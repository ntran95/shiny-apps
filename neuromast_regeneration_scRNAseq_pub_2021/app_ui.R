...
# column(8, tags$b(uiOutput("SelectedDataDiff "))),
  ...
  #tabPanel(title = "Pseudotime Analysis",value = "pseudotime")
  #tabPanel(tags$a(href = 'https://piotrowskilab.shinyapps.io/pseudotime_regen_traj_Sungmin/'),title = "test")
  navbarMenu("Pseudotime Analysis", 
             tabPanel(a("Redirect to Pseudotime Shiny App",
                        href="https://piotrowskilab.shinyapps.io/pseudotime_regen_traj_Sungmin/",
                        target="_blank"))) #target="_blank" makes new tab
  #tabPanel(title=HTML("href='https://piotrowskilab.shinyapps.io/pseudotime_regen_traj_Sungmin/' target='_blank'>Pseudotime Analysis"))
  #tabPanel(title = "Pseudotime Analysis",value = "pseudotime",uiOutput("Link"))
	), style = 'width:1500px;')#,
